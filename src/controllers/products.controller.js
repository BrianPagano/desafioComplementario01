 ...
 // const productManager = new ProductManager('./archivo/products.json')  --> FS se dehabilita por mongo
...
router.get('/', async (req, res) => {
    ...
    // realizo una validación para saber si existe limit, si no, traigo todos los productos
